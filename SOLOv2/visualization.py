...
_COLORS = np.array([
    ...
    1.000, 0.000, 0.000, 0.000, 0.333, 0.000, 0.000, 0.500, 0.000, 0.000,
    0.667, 0.000, 0.000, 0.833, 0.000, 0.000, 1.000, 0.143, 0.143, 0.143,
...
def draw_instances(image,
    ...
    bg_slice = tf.zeros((1, nx, ny), dtype=tf.int32)
    labeled_masks = tf.concat([bg_slice, masks], axis=0)
    labeled_masks = tf.argmax(labeled_masks, axis=0).numpy()
